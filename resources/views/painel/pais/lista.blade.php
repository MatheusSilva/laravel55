...
<div class="col-md-12">
    <form class="form-padrao form-inline padding-20 form-pesquisa" method="POST" send="">
...
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>{{$pai->email}}</td>
        <td>
            <a class="delete" onclick="del('../{{$pai->id}}')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-padrao form-gestao" action="../" send="../">
