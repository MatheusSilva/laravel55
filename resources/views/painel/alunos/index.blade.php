...
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>{{$aluno->turma}}</td>
        <td>
            <a href='{{url("http://localhost/laravel55/painel/alunos/pais/{$aluno->id}")}}' class="edit">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-padrao form-gestao" action="http://localhost/laravel55/painel/alunos" send="http://localhost/laravel55/painel/alunos">
...
@section('scripts')    
    <script>
        var urlAdd = 'http://localhost/laravel55/painel/alunos';
    </script>
@endsection